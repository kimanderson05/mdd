...
1. Visit each conflicted file and resolve any conflicts. Save files.
* Once conflicts are resolved and saved, commit changes and pull remote master branch again.
o $ git add -A
o $ git commit -am ‘Relevant detailed commit message.’
o $ git pull github master
3. $ git merge kaTesting 
1. Resolve any conflicts (see 2.2.1)
4. Test 
